...
class ModernClassifierApp(tk.Tk):
    def __init__(self):
        super().__init__()
        self.title("AI Image Classifier — 1000 Classes, created by JP")
        ...
        # Colors & fonts
        self.primary = "#60A5FA"  # soft blue (όχι έντονο)
        self.accent = "#F472B6"  # soft pink
        self.surface = "#1E293B"  # dim dark (όχι μαύρο)
        self.card = "#273449"  # lighter card
        self.text = "#E2E8F0"  # soft white
        self.muted = "#94A3B8"  # balanced gray
